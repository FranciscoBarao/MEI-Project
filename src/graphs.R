...
#Longest
print("Longest")
print(mean(q_longest_impares[1:50]))
print(sd(q_longest_impares[1:50]))
print(mean(q_longest_pares[1:50]))
print(sd(q_longest_pares[1:50]))
print(mean(q_longest_impares[51:100]))
print(sd(q_longest_impares[51:100]))
print(mean(q_longest_pares[51:100]))
print(sd(q_longest_pares[51:100]))
print(mean(q_longest_impares[101:150]))
print(sd(q_longest_impares[101:150]))
print(mean(q_longest_pares[101:150]))
print(sd(q_longest_pares[101:150]))
print(mean(b_longest_impares[1:50]))
print(sd(b_longest_impares[1:50]))
print(mean(b_longest_pares[1:50]))
print(sd(b_longest_pares[1:50]))
print(mean(b_longest_impares[51:100]))
print(sd(b_longest_impares[51:100]))
print(mean(b_longest_pares[51:100]))
print(sd(b_longest_pares[51:100]))
print(mean(b_longest_impares[101:150]))
print(sd(b_longest_impares[101:150]))
print(mean(b_longest_pares[101:150]))
print(sd(b_longest_pares[101:150]))
print(mean(m_longest_impares[1:50]))
print(sd(m_longest_impares[1:50]))
print(mean(m_longest_pares[1:50]))
print(sd(m_longest_pares[1:50]))
print(mean(m_longest_impares[51:100]))
print(sd(m_longest_impares[51:100]))
print(mean(m_longest_pares[51:100]))
print(sd(m_longest_pares[51:100]))
print(mean(m_longest_impares[101:150]))
print(sd(m_longest_impares[101:150]))
print(mean(m_longest_pares[101:150]))
print(sd(m_longest_pares[101:150]))
print(mean(i_longest_impares[1:50]))
print(sd(i_longest_impares[1:50]))
print(mean(i_longest_pares[1:50]))
print(sd(i_longest_pares[1:50]))
print(mean(i_longest_impares[51:100]))
print(sd(i_longest_impares[51:100]))
print(mean(i_longest_pares[51:100]))
print(sd(i_longest_pares[51:100]))
print(mean(i_longest_impares[101:150]))
print(sd(i_longest_impares[101:150]))
print(mean(i_longest_pares[101:150]))
print(sd(i_longest_pares[101:150]))


#Steps
print("Steps")
print(mean(q_steps_impares[1:50]))
print(sd(q_steps_impares[1:50]))
print(mean(q_steps_pares[1:50]))
print(sd(q_steps_pares[1:50]))
print(mean(q_steps_impares[51:100]))
print(sd(q_steps_impares[51:100]))
print(mean(q_steps_pares[51:100]))
print(sd(q_steps_pares[51:100]))
print(mean(q_steps_impares[101:150]))
print(sd(q_steps_impares[101:150]))
print(mean(q_steps_pares[101:150]))
print(sd(q_steps_pares[101:150]))
print(mean(m_steps_impares[1:50]))
print(sd(m_steps_impares[1:50]))
print(mean(m_steps_pares[1:50]))
print(sd(m_steps_pares[1:50]))
print(mean(m_steps_impares[51:100]))
print(sd(m_steps_impares[51:100]))
print(mean(m_steps_pares[51:100]))
print(sd(m_steps_pares[51:100]))
print(mean(m_steps_impares[101:150]))
print(sd(m_steps_impares[101:150]))
print(mean(m_steps_pares[101:150]))
print(sd(m_steps_pares[101:150]))
print(mean(i_steps_impares[1:50]))
print(sd(i_steps_impares[1:50]))
print(mean(i_steps_pares[1:50]))
print(sd(i_steps_pares[1:50]))
print(mean(i_steps_impares[51:100]))
print(sd(i_steps_impares[51:100]))
print(mean(i_steps_pares[51:100]))
print(sd(i_steps_pares[51:100]))
print(mean(i_steps_impares[101:150]))
print(sd(i_steps_impares[101:150]))
print(mean(i_steps_pares[101:150]))
print(sd(i_steps_pares[101:150]))
print(mean(b_steps_impares[1:50]))
print(sd(b_steps_impares[1:50]))
print(mean(b_steps_pares[1:50]))
print(sd(b_steps_pares[1:50]))
print(mean(b_steps_impares[51:100]))
print(sd(b_steps_impares[51:100]))
print(mean(b_steps_pares[51:100]))
print(sd(b_steps_pares[51:100]))
print(mean(b_steps_impares[101:150]))
print(sd(b_steps_impares[101:150]))
print(mean(b_steps_pares[101:150]))
print(sd(b_steps_pares[101:150]))
